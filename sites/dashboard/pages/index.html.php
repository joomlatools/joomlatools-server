...
---
        ...
        <main class="flex-1 h-screen overflow-y-scroll overflow-x-hidden">
            <div class="md:hidden justify-between items-center bg-black text-white flex">
                <h1 class="font-jt text-2xl font-bold px-4">Joomlatools Server</h1>
                        ...
                        <tbody class="text-gray-600 text-sm">
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">pagestest</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-jtblue-200 text-jtblue-600 py-1 px-3 rounded-full text-xs">Pages</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    0.23
                                </td>
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">joomla3test</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">Joomla 3</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    3.10.99
                                </td>
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">joomla3test2</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">Joomla 3</span>
                                </td>
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">joomla4test</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Joomla 4</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    4.0.10
                                </td>
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">joomla4test2</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Joomla 4</span>
                                </td>
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">wptest</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-yellow-200 text-yellow-600 py-1 px-3 rounded-full text-xs">WordPress</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    5.9.1
                                </td>
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">wordpresstest</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-yellow-200 text-yellow-600 py-1 px-3 rounded-full text-xs">WordPress</span>
                                </td>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span><a href="#" class="underline text-jtblue-900">example.com</a></span>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-jtblue-200 text-jtblue-600 py-1 px-3 rounded-full text-xs">Pages</span>
                                </td>
