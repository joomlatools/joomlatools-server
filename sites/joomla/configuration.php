...
class JConfig
{
	...
	public $db = 'sites_joomla';                         // Database name
	public $dbprefix = 'j_';               // Any random string ending with _
	...
	/* Server Settings */
	public $secret = 'dJUh9lVCcx1jIlxZ';     // Use something very secure. For example on linux the following command `cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w ${1:-16} | head -n 1`
	public $gzip = false;
	public $error_reporting = 'default';
	public $helpurl = 'https://help.joomla.org/proxy?keyref=Help{major}{minor}:{keyref}&lang={langcode}';
	public $tmp_path = '/var/www/sites/joomla/tmp/';                // This path needs to be writable by Joomla!
	public $log_path = '/var/www/sites/joomla/logs/'; // This path needs to be writable by Joomla!
