      ...
      setupEditor: function setupEditor(element, pluginOptions) {
        ...
        Joomla.editors.instances[element.id] = {
          ...
          getSelection: function getSelection() {
            return Joomla.editors.instances[element.id].instance.selection.getContent({
              format: 'text'
            });
          },
          ...
          disable: function disable(disabled) {
            return Joomla.editors.instances[element.id].instance.setMode(disabled ? 'readonly' : 'design');
          },
