(function () {
  ...
  */
  ...
  var loadOptions = function loadOptions(instance, customOptions) {
    var options = customOptions ? Object.assign(defaultOptions, customOptions) : defaultOptions; // Check required options
  ...
  var Jooa11y = /*#__PURE__*/function () {
    function Jooa11y(options) {
      ...
      this.checkAll = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      this.buildPanel = function () {
        ...
        var $headingAnnotations = document.querySelectorAll(".jooa11y-heading-label"); //Show outline panel
      ...
      this.skipToIssue = function () {
        ...
        */
        ...
        var skipToIssueToggle = function skipToIssueToggle() {
          ...
          var $alertPanel = document.getElementById("jooa11y-panel-alert");
          var $alertText = document.getElementById("jooa11y-panel-alert-text");
          var $alertPanelPreview = document.getElementById("jooa11y-panel-alert-preview"); //const $closeAlertToggle = document.getElementById("jooa11y-close-alert");
    ...
    _proto.jooa11yMainToggle = function jooa11yMainToggle() {
      ...
      jooa11yToggle.addEventListener('click', function (e) {
        if (localStorage.getItem("jooa11y-remember-panel") === "Opened") {
          ...
          _this2.checkAll(); //Don't show badge when panel is opened.
    ...
    _proto.settingPanelToggles = function settingPanelToggles() {
      ...
      $jooa11yContrastCheck.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      ...
      $jooa11yLabelsCheck.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      ...
      $jooa11yChangeRequestCheck.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      ...
      $jooa11yReadabilityCheck.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
      ...
      $jooa11yTheme.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var theme;
    ...
    _proto.checkLinksAdvanced = function checkLinksAdvanced() {
      ...
      $linksTargetBlank.forEach(function (el) {
        ...
        var alt = $img ? $img.getAttribute('alt') || '' : ''; //Return link text and image's alt text.
    ...
    _proto.checkQA = function checkQA() {
      ...
      this.$p.forEach(function ($el) {
        ...
        var brBefore = $el.innerHTML.indexOf("<br></strong>"); //Check paragraphs greater than x characters.

        if ($el && $el.textContent.trim().length >= 300) {
          var firstChild = $el.firstChild; //If paragraph starts with <strong> tag and ends with <br>.
    ...
    _proto.annotate = function annotate(type, content, inline) {
      ...
      var CSSName = (_CSSName = {}, _CSSName[validTypes[0]] = "error", _CSSName[validTypes[1]] = "warning", _CSSName[validTypes[2]] = "good", _CSSName); // Check if content is a function
    ...
    _proto.annotateBanner = function annotateBanner(type, content) {
      ...
      var CSSName = (_CSSName2 = {}, _CSSName2[validTypes[0]] = "error", _CSSName2[validTypes[1]] = "warning", _CSSName2[validTypes[2]] = "good", _CSSName2); // Check if content is a function
