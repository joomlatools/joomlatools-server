            ...
            <div class="bg-white shadow rounded-sm my-2.5 overflow-x-auto">
                <table class="min-w-max w-full table-auto">
                    ...
                    <tbody class="text-gray-600 text-sm">
                        <?php $id = 1; foreach($this->data('sites') as $site) : ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <span><a href="#" class="underline text-jtblue-900"><?php echo $site->name ?></a></span>
                            </td>
                            <td class="py-3 px-6 text-center">
                                <span class="bg-<?php echo $site->platform_bg_color ?> text-<?php echo $site->platform_text_color ?> py-1 px-3 rounded-full text-xs"><?php echo $site->platform_name ?></span>
                            </td>
                            <td class="py-3 px-6 text-center">
                                <?php echo $site->platform_version ?>
                            </td>
                            <td class="py-3 px-6 text-center">
